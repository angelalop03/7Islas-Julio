...
public class GameServiceTest {
    ...
    void shouldFindGamesByStatus() {
        List<Game> games = this.gameService.findByState(GameState.FINISHED);
        assertEquals(2, games.size());
    }
    ...
    void shouldFindGamesByUserId() {
        List<Game> games = this.gameService.findGamesByUserId(4);
    ...
    void findGamesUnstartedByUserId() {
        ...
        assertEquals(0, gameService.findGamesByUserIdNotStarted(4).size());
    }
    ...
    void findRecentGameByPlayerId() {
        assertEquals(1, gameService.findRecentGameByPlayerId().getId());
    }
    ...
    void shouldAddPlayersToGame() {
        ...
        partidaEmpezada.setStartDate(LocalDateTime.of(2023, 12, 12, 12, 30));
        gameService.updateGameByGameId(partidaEmpezada.getId(), partidaEmpezada);

        assertEquals(LocalDateTime.of(2023, 12, 12, 12, 30), partidaEmpezada.getStartDate());
    ...
    void shouldStartGameByGameId() {
        ...
        assertNotNull(partidaEmpezada.getStartDate());
        assertNull(partidaEmpezada.getEndDate());
    }
    ...
    void shouldUpdateTurnByGameId() {
        ...
        Player playerInTurnBeforeUpdate = startedGame.getPlayers().stream().dropWhile(Player::getTurn).toList().get(0);
        Game updatedGame = gameService.updateTurnByGameId(startedGame.getId());
        Player playerInTurnAfterUpdate = updatedGame.getPlayers().stream().dropWhile(Player::getTurn).toList().get(0);
    ...
    void shouldFinishGame() throws Exception {
        ...
        assertNotNull(finishedGame.getEndDate());
    }
